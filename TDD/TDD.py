...
class Node:
    ...
    def mystr(self,depth=0) -> str:
        ...
        return '├───→'*depth+'key:'+str(self.key)+' out_weight:'+str(self.out_weight)+"\n "+''.join([self.successor[i].mystr(depth+1) if self.successor[i] is not None else '' for i in range (self.succ_num) ])
