...
class TestHashDouble(unittest.TestCase):
    ...
    def test_005(self) -> None:
        ...
        '''
        self.assertNotEqual(hashing.hash_double(0.05), hashing.hash_double(0.05000000000000001))
        self.assertNotEqual(hashing.hash_double(0.05), hashing.hash_double(0.04999999999999999))
